...
function getElement(element) {
  var targetWindow = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : window;
...
function getMergedStep(step, props) {
  ...
  var scrollParent = hasCustomScrollParent(getElement(step.target, step === null || step === void 0 ? void 0 : (_step$iframe = step.iframe) === null || _step$iframe === void 0 ? void 0 : _step$iframe.contentWindow), mergedStep.disableScrollParentFix);
...
var JoyrideOverlay = /*#__PURE__*/function (_React$Component) {
  ...
  function JoyrideOverlay() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleScroll", function () {
      ...
      var element = getElement(target, iframe === null || iframe === void 0 ? void 0 : iframe.contentWindow);
  ...
  _createClass(JoyrideOverlay, [{
    ...
    get: function get() {
      ...
      var _this$props4 = this.props,
          ...
          iframe = _this$props4.iframe;
      var element = getElement(target, iframe === null || iframe === void 0 ? void 0 : iframe.contentWindow);
      var elementRect = getClientRect(element);
      var isFixedTarget = hasPosition(element);
      var top = getElementPosition(element, spotlightPadding, disableScrollParentFix, iframe === null || iframe === void 0 ? void 0 : iframe.top);
      var left = iframe ? Math.round(elementRect.left - spotlightPadding) + iframe.left : Math.round(elementRect.left - spotlightPadding);
    ...
    value: function render() {
      ...
      var _this$props5 = this.props,
          ...
          disableOverlayClose = _this$props5.disableOverlayClose,
          lifecycle = _this$props5.lifecycle,
          onClickOverlay = _this$props5.onClickOverlay,
  ...
  _createClass(JoyrideStep, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (hasStoreChanged && step) {
        ...
        var element = getElement(step.target, step === null || step === void 0 ? void 0 : (_step$iframe = step.iframe) === null || _step$iframe === void 0 ? void 0 : _step$iframe.contentWindow);
    ...
    value: function render() {
      ...
      var target = getElement(step.target, step === null || step === void 0 ? void 0 : (_step$iframe2 = step.iframe) === null || _step$iframe2 === void 0 ? void 0 : _step$iframe2.contentWindow);
...
var Joyride = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Joyride, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      var target = getElement(step === null || step === void 0 ? void 0 : step.target, step === null || step === void 0 ? void 0 : (_step$iframe = step.iframe) === null || _step$iframe === void 0 ? void 0 : _step$iframe.contentWindow);
    ...
    value: function scrollToStep(prevState) {
      ...
      if (step) {
        ...
        var target = getElement(step.target, (_step$iframe2 = step.iframe) === null || _step$iframe2 === void 0 ? void 0 : _step$iframe2.contentWindow);
